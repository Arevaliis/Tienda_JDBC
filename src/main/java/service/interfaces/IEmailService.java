...
public interface IEmailService {
     ...
     * @throws ServiceException si el cliente no existe, el email ya está registrado u ocurre un error durante la operación
     */
     ...
     * @throws ServiceException si el email no existe, el nuevo email ya está en uso u ocurre un error durante la operación
     */
    void modificarNombreEmail(String nuevoEmail, int idEmail) throws ServiceException;
     ...
     * @throws ServiceException si el email no existe u ocurre un error en la búsqueda
     */
     ...
     * @throws ServiceException si el email o el cliente no existen u ocurre un error durante la operación
     */
    void modificarIdClienteEmail(int nuevoClienteId, int idCliente) throws ServiceException;
     ...
     * @throws ServiceException si el cliente no existe u ocurre un error en la consulta
     */
     ...
     * @throws ServiceException si el email no existe u ocurre un error durante la eliminación
     */
